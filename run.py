...
"""clipper orchestrator.
    ...
    python run.py --url URL --clips 6 --no-publish   # 6 shorts from one YouTube link, nothing posted
    python run.py               # one full pass: ingest → transcribe → highlight → render → publish → export
...
from clipper import highlight, ingest, publish, render, submissions, transcribe  # noqa: E402
